...
/*
        ...
        imageView.setOnClickListener(new OnSingleClickListener() {
            ...
            public void onSingleClick(View v) {
                ...
                ImageLoader.showWithPlaceholder("https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTEB-0Ce1lQdCmrXLFSIhOP8-SHL1Amuq54Jg&usqp=CAU", new ImageLoader.IImageLoad() {
                    @Override
                    public void finnish(Bitmap bitmap) {
                        if (bitmap == null) {
                            PrintLog.print("null found!");
                        } else {
                            PrintLog.print("Success!");
